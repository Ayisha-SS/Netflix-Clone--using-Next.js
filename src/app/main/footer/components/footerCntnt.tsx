...
export default function FooterCntnt() {
  return (
    <>
        <div className='font-sans text-white text-sm text-opacity-70 font-normal py-16 lg:py-12 md:text-[15px] sm:text-[17px]'>
            <div className=' mb-3'>
                Questions? Call <a href="tel:000-800-919-1694" className='underline'>000-800-919-1694</a>
            </div>
            <div className='flex flex-wrap'>
                <div className='mr-8 lg:-mr-1'>
                    <ul className='underline mt-4 p-0 mr-40 lg:whitespace-nowrap'>
