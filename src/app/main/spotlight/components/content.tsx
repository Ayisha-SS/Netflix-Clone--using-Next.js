...
export default function Content() {
  return (
    <>
        <div className='flex flex-col justify-center items-center min-h-10 pt-44 w-[100%] xl:pt-32'>
            <div className='w-[80%] text-center'>
                <h2 className='text-white text-5xl font-black  font-sans m-0 '>Enjoy big movies, hit series and more from &#8377;149.</h2>
            </div>
            <div className='pt-12 xl:pt-6'>
            ...
            <div className='flex items-center justify-center pt-6 xl:pb-'>
